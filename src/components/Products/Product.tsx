...
const Product = ({ productDetails }: ProductProps) => {
  ...
  const { id, title, thumbnail, price, rating, description } = productDetails;
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col h-[100%] items-start gap-y-3">
        ...
        <div className="clamp-text text-sm text-gray-500">{description}</div>
      ...
      {isMouseOver && (
        ...
        >
          <span
            className={`w-15 h-15 bg-gray-100 flex items-center justify-center rounded-full ${
